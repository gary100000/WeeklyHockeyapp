...
export default async function Roster() {
 ...
 const groups=[["Playing","green"],["AddedAsSub","blue"],["No","red"],["Waiting","yellow"]];
 ...
 {groups.map(([status,cls])=><section key={status}><h3 className={cls}>{status==="AddedAsSub"?"SUBS":status.toUpperCase()}</h3>
